...
public class Shelves extends AppCompatActivity implements MyInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initiate adapter
        booksAdapter = new FavoritesAdapter(Shelves.this, favoriteModels, this, "books" );
...
//        });
    ...
    private void setUpBooks() {
        ...
        CollectionReference bookRef = firestore.collection("SHELVES");
                ...
                .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                            favoriteModels.add(new FavoriteModel(documentSnapshot.getId(),documentSnapshot.get("name").toString(), documentSnapshot.get("image_URL").toString(), documentSnapshot.get("author").toString()));
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Shelves.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        shimmerFrameLayout.stopShimmer();
                        shimmerFrameLayout.setVisibility(View.GONE);
                    }
                });
...
//        });
        ...
        recycler_books.setLayoutManager(new LinearLayoutManager(Shelves.this));
    }
    ...
    public void onItemClick(int pos, String onclick) {
        ...
        Intent intent = new Intent(Shelves.this, BookDetails.class);
