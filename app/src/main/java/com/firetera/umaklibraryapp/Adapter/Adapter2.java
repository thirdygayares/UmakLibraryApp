...
public class Adapter2 extends RecyclerView.Adapter<Adapter2.MyViewHolder> {
    ...
    public Adapter2(Context context, ArrayList<Model1> model1, MyInterface myInterfaces, String onclick){
    ...
    public Adapter2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType  ) {
        ...
        View view = inflater.inflate(R.layout.recycler_adapter2, parent, false);

        return new Adapter2.MyViewHolder(view, myInterfaces, onclick);
    }
    ...
    public void onBindViewHolder(@NonNull Adapter2.MyViewHolder holder, int position) {
        ...
        Picasso.get().load(model1.get(position).getImagestring()).placeholder(R.drawable.placeholder).error(R.drawable.placeholder).resize(720,1080).centerCrop().into(holder.image);
